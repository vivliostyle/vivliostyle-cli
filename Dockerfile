...
RUN --security=insecure \
  ...
  && mmdebstrap \
    ...
    --customize-hook='ln --symbolic --force /usr/lib/node_modules/pnpm/pnpm "$1/usr/bin/pnpm"' \
    --customize-hook='ln --symbolic --force /usr/lib/node_modules/pnpm/pnpx "$1/usr/bin/pnpx"' \
